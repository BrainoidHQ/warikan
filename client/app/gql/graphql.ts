...
export type GetGroupDetailQuery = {
  ...
  group?: {
    ...
    createdAt: any;
    title: string;
    participants: Array<{ __typename?: "User"; id: string; name: string }>;
    payments: Array<{
      __typename?: "Payment";
      id: string;
      createdAt: any;
    ...
    warikan: Array<{
      ...
      to: { __typename?: "User"; id: string; name: string };
    }>;
  } | null;
};
...
export type UpdatePaymentMutation = {
  __typename?: "Mutation";
  updatePayment: { __typename?: "Payment"; id: string };
};
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetGroupDetail" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<GetGroupDetailQuery, GetGroupDetailQueryVariables>;
...
export const GetPaymentDetailDocument = {
  ...
  GetPaymentDetailQueryVariables
>;
